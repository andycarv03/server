...
return{
	...
	addNewCertificate: async function(req, res, next) {
	...
	var PRno = req.body['cert_PRno']
		...
		/*var PRno=req.params.id1
		var CName=req.params.id2
		var Seatno=req.params.id3
		var examination=req.params.id4
		var YOP=req.params.id5
		var sub=req.params.id6*/
	...
	addStudentRecord: async function(req, res, next) {
		//console.log(req.body);
		//console.log(req);
		console.log("submit recording of a student catch: ");
	    ...
	    var branch = req.body['cert_BName'];
		var YOP = req.body['cert_YOP'];
		var email=req.body['cert_email'];
		var number = req.body['cert_number'];
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'securecert-app',
		        fcn: 'addStudent',
		        args: [PRno,password,fname,mname,lname,CName,branch,YOP,email,number],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
